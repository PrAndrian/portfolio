...
export const skills = [
  {
    ...
    description:
      "Proficient in writing clean, efficient, and maintainable code using JavaScript, HTML, and CSS and frameworks like React, Vue.js, Next.js. Skilled in implementing algorithms, data structures, and following best coding practices to develop responsive and user-friendly web applications.",
  },
  {
    tag: "Hardskill",
    title: "CI/CD",
    description:
      "Experience in setting up CI/CD pipelines using tools like Jenkins, GitLab CI/CD, or GitHub Actions. Proficient in automating the build, test, and deployment processes to ensure efficient and consistent software delivery.",
  },
  {
    tag: "Hardskill",
    title: "Databases and Architecture",
    description:
      "Familiarity with database concepts and able to integrate frontend components with databases. Understanding of database management systems like MySQL, MongoDB, or SQLite. Knowledge of architecting frontend applications for scalability and performance.",
  },
  {
    tag: "Hardskill",
    title: "Testing / Debugging",
    description:
      "Skilled in writing and implementing various testing methodologies such as unit testing, integration testing, and end-to-end testing using frameworks like Jest or Cypress. Proficient in debugging and resolving issues to ensure the robustness of the codebase.",
  },
  {
    tag: "Softskill",
    title: "Discovery and Business Impact",
    description:
      "Ability to understand the business requirements and translate them into technical solutions. Proficient in collaborating with stakeholders to identify project needs, suggesting technological solutions, and delivering impactful frontend applications that align with business goals.",
  },
];
