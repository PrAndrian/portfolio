  ...
  return (
    <div className="bckg-fundamental bg-cover bg-center py-40 mt-20" >
        <div className="container mx-auto text-center flex flex-col space-y-10 xl:space-y-8 px-5 lg:px-0">
            ...
            <Link to="mailto:princy.workspace@gmail.com" className="mx-auto text-lg transition-all duration-300 bg-[#5E17EB] text-white flex-shrink py-3 px-6 rounded font-bold flex items-center space-x-2 mr-auto mt-4 hover:opacity-80 group fade-in-fast">
