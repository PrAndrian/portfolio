            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 lg:gap-x-10 xl:gap-x-20 px-5 space-y-10 lg:space-y-0">
                ...
                <div className="flex flex-col space-y-5 text-white">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-5 gap-x-5">
                        <a href="/about" className="hover:text-[#5E17EB] transition-all duration-300">About us</a>
                        <a href="/services" className="hover:text-[#5E17EB] transition-all duration-300">Services</a>
                        <a href="/projects" className="hover:text-[#5E17EB] transition-all duration-300">Portfolio</a>
                        <a href="/process" className="hover:text-[#5E17EB] transition-all duration-300">Our Process</a>
                        <a href="/careers" className="hover:text-[#5E17EB] transition-all duration-300">Careers</a>
                        <a href="/feed" className="hover:text-[#5E17EB] transition-all duration-300">Feed</a>
                        <a href="/contacts" className="hover:text-[#5E17EB] transition-all duration-300">Contact us</a>
                    </div>
                </div>
                <div className="flex flex-col space-y-5 text-white">
                ...
                <div className="flex flex-col space-y-5 text-white">
                    ...
                    <a href="mailto:hello@fundamental.bg" rel="noopener noreferrer" className="hover:text-[#5E17EB] transition-all duration-300">hello@fundamental.bg</a>
                    <a href="tel:+359895697410" rel="noopener noreferrer" className="hover:text-[#5E17EB] transition-all duration-300">+359 895 69 74 10</a>
                    <div className="grid grid-cols-6">
                        <a href="https://www.facebook.com/studio.fundamental" rel="noopener noreferrer" target="blank" className="hover:text-[#5E17EB] transition-all duration-300">A</a>
                        <a href="https://www.instagram.com/fundamental.studio/" rel="noopener noreferrer" target="blank" className="hover:text-[#5E17EB] transition-all duration-300">B</a>
                        <a href="https://www.linkedin.com/company/fundamental-studio-ltd" rel="noopener noreferrer" target="blank" className="hover:text-[#5E17EB] transition-all duration-300">C</a>
                        <a href="https://www.behance.net/fundamendalstudio" rel="noopener noreferrer" target="blank" className="hover:text-[#5E17EB] transition-all duration-300">D</a>
                    </div>
                </div>
            </div>
        </div>
