...
const ProjectDescription = ({title,description,company,year,url=""}) => {
  return (
    <div className="container mx-auto lg:px-8">
        <div className="flex items-center space-x-10">
            ...
            <Link to={url}target="blank" className="hidden lg:flex text-lg transition-all duration-300 bg-[#5E17EB] text-white flex-shrink py-3 px-6 rounded font-bold items-center space-x-2 mr-auto hover:opacity-80 group">
